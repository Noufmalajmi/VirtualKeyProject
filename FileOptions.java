...
public class FileOptions implements HomeScreen {
	
	private DirectoryPath dirpath = new DirectoryPath();
    ...
    public void AddFile() {
		...
		try {
			...
			File file = new File(dirpath.getName() + fileName);
			
		      if (file.createNewFile()) {
		    	  System.out.println("File created: " + file.getName());
		    	  dirpath.getFiles().add(file);
    ...
    public void SearchFile() {
        ...
        ArrayList<File> files = dirpath.getFiles();
